document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadData() {
        fetch('../../../fichiers_json/statistiques/joueurs/stats_joueurs_euroleague.json')  // Remplacez par le chemin vers votre fichier JSON
            .then(response => {
                if (!response.ok) {
    ...
    function displayPage(pageNumber) {
        ...
        const tbody = document.querySelector("#euroligue-stats-table tbody");
